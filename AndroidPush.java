...
public class AndroidPush {
     ...
     */
    private static String SERVER_KEY = AIzaSyAjYMU092IgovOLBnlsOoUf0tWfGCdOWH8;
    ...
    private static void sendPushNotification(String title, String message) throws Exception {
        ...
        conn.setRequestProperty("Authorization", "key=" + AIzaSyAjYMU092IgovOLBnlsOoUf0tWfGCdOWH8);
